...
class _ApiService implements ApiService {
  _ApiService(
    ...
    baseUrl ??= 'https://www.trendapp.org/test-project/public/api';
  }
  ...
  Future<CategoryMealsModel> gettingCategoryDetails(
    ...
    final _options = _setStreamType<CategoryMealsModel>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    late CategoryMealsModel _value;
    try {
      _value = CategoryMealsModel.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<CheckoutResponseModel> checkOut(
    ...
    _data.addAll(body);
    final _options = _setStreamType<CheckoutResponseModel>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
